...
export class AssemblyForNode implements Node {
    ...
    accept(find: FinderType, documentsAnalyzerTree: DocumentsAnalyzerTree, orphanNodes: Node[], parent?: Node, expression?: Node): Node {
        ...
        find(this.astNode.pre, this.uri).accept(find, documentsAnalyzerTree, orphanNodes, this);
        find(this.astNode.condition, this.uri).accept(find, documentsAnalyzerTree, orphanNodes, this);
        find(this.astNode.post, this.uri).accept(find, documentsAnalyzerTree, orphanNodes, this);
