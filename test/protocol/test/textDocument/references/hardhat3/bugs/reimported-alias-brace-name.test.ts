...
describe('[hardhat3] references bug - an alias re-imported from the file that made it loses its name in the braces', () => {
  let basePath: string
  ...
  before(async () => {
    ...
    basePath = getProjectPath('hardhat3/contracts/references/import-forms/IfBase.sol')
    userAPath = getProjectPath('hardhat3/contracts/references/import-forms/IfUserA.sol')
    userBPath = getProjectPath('hardhat3/contracts/references/import-forms/IfUserB.sol')
    userCPath = getProjectPath('hardhat3/contracts/references/import-forms/IfUserC.sol')
