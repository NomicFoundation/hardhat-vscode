...
describe('[foundry] references bug - an alias re-imported from the file that made it loses its name in the braces', () => {
  ...
  before(async () => {
    ...
    userBPath = getProjectPath('foundry/src/references/import-forms/IfUserB.sol')
    userCPath = getProjectPath('foundry/src/references/import-forms/IfUserC.sol')
