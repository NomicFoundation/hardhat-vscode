...
describe('[hardhat] references - variables', () => {
  let basePath: string
  ...
  before(async () => {
    ...
    basePath = getProjectPath('hardhat/contracts/references/variables/RvBase.sol')
    vaultPath = getProjectPath('hardhat/contracts/references/variables/RvVault.sol')
    localsPath = getProjectPath('hardhat/contracts/references/variables/RvLocals.sol')
    transientPath = getProjectPath('hardhat/contracts/references/variables/RvTransient.sol')
