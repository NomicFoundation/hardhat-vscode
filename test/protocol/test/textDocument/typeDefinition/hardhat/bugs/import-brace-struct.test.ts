...
describe('[hardhat] typeDefinition bug - a struct named in an import brace list is never bound', () => {
  ...
  before(async () => {
    ...
    importerPath = getProjectPath('hardhat/contracts/type-definition/import-forms/IfImporter.sol')
    shapesPath = getProjectPath('hardhat/contracts/type-definition/import-forms/IfShapes.sol')
    otherPath = getProjectPath('hardhat/contracts/type-definition/import-forms/IfOther.sol')
    midPath = getProjectPath('hardhat/contracts/type-definition/import-forms/IfMid.sol')
    deepPath = getProjectPath('hardhat/contracts/type-definition/import-forms/IfDeep.sol')
