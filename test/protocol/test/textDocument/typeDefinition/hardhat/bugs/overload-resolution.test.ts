...
describe('[hardhat] typeDefinition bug - bare call binds to the first-declared overload', () => {
  let overloadsPath: string

  before(async () => {
    client = await getInitializedClient()
    overloadsPath = getProjectPath('hardhat/contracts/type-definition/bugs/overload-resolution/FnOverloads.sol')
