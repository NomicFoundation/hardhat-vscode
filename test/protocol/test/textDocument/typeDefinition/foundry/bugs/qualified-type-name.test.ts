...
describe('[foundry] typeDefinition bug - qualified type name looked up as one dotted name', () => {
  ...
  before(async () => {
    ...
    shapesPath = getProjectPath('foundry/src/type-definition/data-types/DtShapes.sol')
