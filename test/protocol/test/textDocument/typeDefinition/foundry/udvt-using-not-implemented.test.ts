...
describe('[foundry] typeDefinition - udvt-using (not implemented)', () => {
  ...
  before(async () => {
    ...
    pricePath = getProjectPath('foundry/src/type-definition/udvt-using/UuPrice.sol')
    vaultPath = getProjectPath('foundry/src/type-definition/udvt-using/UuVault.sol')
