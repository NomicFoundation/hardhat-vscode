...
describe('[hardhat3] type definition', () => {
  let testPath: string
  ...
  before(async () => {
    ...
    testPath = getProjectPath('hardhat3/contracts/typedefinition/Test.sol')
    importedPath = getProjectPath('hardhat3/contracts/typedefinition/Imported.sol')
