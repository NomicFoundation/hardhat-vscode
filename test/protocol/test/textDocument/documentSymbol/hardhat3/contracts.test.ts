...
describe('[hardhat3] documentSymbol - contracts', () => {
  ...
  before(async () => {
    ...
    kindsPath = getProjectPath('hardhat3/contracts/document-symbols/contracts/CtKinds.sol')
    interfacesPath = getProjectPath('hardhat3/contracts/document-symbols/contracts/CtInterfaces.sol')
    libraryPath = getProjectPath('hardhat3/contracts/document-symbols/contracts/CtLibrary.sol')
    inheritPath = getProjectPath('hardhat3/contracts/document-symbols/contracts/CtInherit.sol')
    oneLinePath = getProjectPath('hardhat3/contracts/document-symbols/contracts/CtOneLine.sol')
    sameNamesPath = getProjectPath('hardhat3/contracts/document-symbols/contracts/CtSameNames.sol')
