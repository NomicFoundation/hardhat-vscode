...
describe('[hardhat3] documentSymbol - types', () => {
  ...
  before(async () => {
    ...
    fileLevelPath = getProjectPath('hardhat3/contracts/document-symbols/types/TyFileLevel.sol')
    membersPath = getProjectPath('hardhat3/contracts/document-symbols/types/TyMembers.sol')
    nestedPath = getProjectPath('hardhat3/contracts/document-symbols/types/TyNested.sol')
    contractPath = getProjectPath('hardhat3/contracts/document-symbols/types/TyContract.sol')
    enumsPath = getProjectPath('hardhat3/contracts/document-symbols/types/TyEnums.sol')
    libIfacePath = getProjectPath('hardhat3/contracts/document-symbols/types/TyLibIface.sol')
  ...
  test('struct members of elementary types', async () => {
    const symbols = (await client.getDocumentSymbols(toUri(membersPath))) as DocumentSymbol[] | null

    expect(shape(at(symbols, ['TyScalars']))).to.deep.equal(
      shape([
        { name: 'ok', kind: 7, children: [] },
        { name: 'amount', kind: 7, children: [] },
        { name: 'delta', kind: 7, children: [] },
        { name: 'wallet', kind: 7, children: [] },
        { name: 'selector', kind: 7, children: [] },
        { name: 'blob', kind: 7, children: [] },
