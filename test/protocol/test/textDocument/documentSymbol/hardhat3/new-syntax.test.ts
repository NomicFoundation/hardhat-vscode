...
describe('[hardhat3] documentSymbol - new-syntax', () => {
  ...
  before(async () => {
    ...
    layoutAtPath = getProjectPath('hardhat3/contracts/document-symbols/new-syntax/NsLayoutAt.sol')
    layoutErc7201Path = getProjectPath('hardhat3/contracts/document-symbols/new-syntax/NsLayoutErc7201.sol')
    operatorsPath = getProjectPath('hardhat3/contracts/document-symbols/new-syntax/NsOperators.sol')
    transientPath = getProjectPath('hardhat3/contracts/document-symbols/new-syntax/NsTransient.sol')
    namedMappingPath = getProjectPath('hardhat3/contracts/document-symbols/new-syntax/NsNamedMapping.sol')
    requireErrorPath = getProjectPath('hardhat3/contracts/document-symbols/new-syntax/NsRequireError.sol')
    qualifiedEmitPath = getProjectPath('hardhat3/contracts/document-symbols/new-syntax/NsQualifiedEmit.sol')
