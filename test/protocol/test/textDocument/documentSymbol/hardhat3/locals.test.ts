...
describe('[hardhat3] documentSymbol - locals', () => {
  ...
  before(async () => {
    ...
    blocksPath = getProjectPath('hardhat3/contracts/document-symbols/locals/Blocks.sol')
    returnsPath = getProjectPath('hardhat3/contracts/document-symbols/locals/Returns.sol')
    specialPath = getProjectPath('hardhat3/contracts/document-symbols/locals/Special.sol')
    assemblyPath = getProjectPath('hardhat3/contracts/document-symbols/locals/Assembly.sol')
