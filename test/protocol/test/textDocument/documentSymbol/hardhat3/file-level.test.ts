...
describe('[hardhat3] documentSymbol - file-level', () => {
  ...
  before(async () => {
    ...
    constantsPath = getProjectPath('hardhat3/contracts/document-symbols/file-level/FlConstants.sol')
    typesPath = getProjectPath('hardhat3/contracts/document-symbols/file-level/FlTypes.sol')
    errorsEventsPath = getProjectPath('hardhat3/contracts/document-symbols/file-level/FlErrorsEvents.sol')
    functionsPath = getProjectPath('hardhat3/contracts/document-symbols/file-level/FlFunctions.sol')
    freeLocalsPath = getProjectPath('hardhat3/contracts/document-symbols/file-level/FlFreeLocals.sol')
    usingPath = getProjectPath('hardhat3/contracts/document-symbols/file-level/FlUsing.sol')
    importsPath = getProjectPath('hardhat3/contracts/document-symbols/file-level/FlImports.sol')
    mixedPath = getProjectPath('hardhat3/contracts/document-symbols/file-level/FlMixed.sol')
