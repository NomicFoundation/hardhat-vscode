...
describe('[hardhat] documentSymbol - contracts', () => {
  ...
  before(async () => {
    ...
    kindsPath = getProjectPath('hardhat/contracts/document-symbols/contracts/CtKinds.sol')
    interfacesPath = getProjectPath('hardhat/contracts/document-symbols/contracts/CtInterfaces.sol')
    libraryPath = getProjectPath('hardhat/contracts/document-symbols/contracts/CtLibrary.sol')
    inheritPath = getProjectPath('hardhat/contracts/document-symbols/contracts/CtInherit.sol')
    oneLinePath = getProjectPath('hardhat/contracts/document-symbols/contracts/CtOneLine.sol')
    sameNamesPath = getProjectPath('hardhat/contracts/document-symbols/contracts/CtSameNames.sol')
