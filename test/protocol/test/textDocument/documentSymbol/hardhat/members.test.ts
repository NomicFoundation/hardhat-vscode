...
describe('[hardhat] documentSymbol - members', () => {
  ...
  before(async () => {
    ...
    stateVarsPath = getProjectPath('hardhat/contracts/document-symbols/members/StateVariables.sol')
    transientPath = getProjectPath('hardhat/contracts/document-symbols/members/Transient.sol')
    specialsPath = getProjectPath('hardhat/contracts/document-symbols/members/SpecialFunctions.sol')
    functionsPath = getProjectPath('hardhat/contracts/document-symbols/members/Functions.sol')
    modifiersPath = getProjectPath('hardhat/contracts/document-symbols/members/Modifiers.sol')
    overridesPath = getProjectPath('hardhat/contracts/document-symbols/members/Overrides.sol')
