...
describe('[hardhat] documentSymbol - locals', () => {
  ...
  before(async () => {
    ...
    blocksPath = getProjectPath('hardhat/contracts/document-symbols/locals/Blocks.sol')
    returnsPath = getProjectPath('hardhat/contracts/document-symbols/locals/Returns.sol')
    specialPath = getProjectPath('hardhat/contracts/document-symbols/locals/Special.sol')
    assemblyPath = getProjectPath('hardhat/contracts/document-symbols/locals/Assembly.sol')
