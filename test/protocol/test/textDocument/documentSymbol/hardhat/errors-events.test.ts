...
describe('[hardhat] documentSymbol - errors-events', () => {
  ...
  before(async () => {
    ...
    errorsEventsPath = getProjectPath('hardhat/contracts/document-symbols/errors-events/ErrorsEvents.sol')
    fileErrorsPath = getProjectPath('hardhat/contracts/document-symbols/errors-events/FileErrors.sol')
    fileEventsPath = getProjectPath('hardhat/contracts/document-symbols/errors-events/FileEvents.sol')
    fileEventOverloadsPath = getProjectPath('hardhat/contracts/document-symbols/errors-events/FileEventOverloads.sol')
