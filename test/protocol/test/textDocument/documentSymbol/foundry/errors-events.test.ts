...
describe('[foundry] documentSymbol - errors-events', () => {
  ...
  before(async () => {
    ...
    errorsEventsPath = getProjectPath('foundry/src/document-symbols/errors-events/ErrorsEvents.sol')
    fileErrorsPath = getProjectPath('foundry/src/document-symbols/errors-events/FileErrors.sol')
    fileEventsPath = getProjectPath('foundry/src/document-symbols/errors-events/FileEvents.sol')
    fileEventOverloadsPath = getProjectPath('foundry/src/document-symbols/errors-events/FileEventOverloads.sol')
