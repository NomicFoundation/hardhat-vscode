...
describe('[foundry] documentSymbol - members', () => {
  ...
  before(async () => {
    ...
    stateVarsPath = getProjectPath('foundry/src/document-symbols/members/StateVariables.sol')
    transientPath = getProjectPath('foundry/src/document-symbols/members/Transient.sol')
    specialsPath = getProjectPath('foundry/src/document-symbols/members/SpecialFunctions.sol')
    functionsPath = getProjectPath('foundry/src/document-symbols/members/Functions.sol')
    modifiersPath = getProjectPath('foundry/src/document-symbols/members/Modifiers.sol')
    overridesPath = getProjectPath('foundry/src/document-symbols/members/Overrides.sol')
