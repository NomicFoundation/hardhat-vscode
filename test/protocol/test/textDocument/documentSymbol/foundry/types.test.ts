...
describe('[foundry] documentSymbol - types', () => {
  ...
  before(async () => {
    ...
    fileLevelPath = getProjectPath('foundry/src/document-symbols/types/TyFileLevel.sol')
    membersPath = getProjectPath('foundry/src/document-symbols/types/TyMembers.sol')
    nestedPath = getProjectPath('foundry/src/document-symbols/types/TyNested.sol')
    contractPath = getProjectPath('foundry/src/document-symbols/types/TyContract.sol')
    enumsPath = getProjectPath('foundry/src/document-symbols/types/TyEnums.sol')
    libIfacePath = getProjectPath('foundry/src/document-symbols/types/TyLibIface.sol')
