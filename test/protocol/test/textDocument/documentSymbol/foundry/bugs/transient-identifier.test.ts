...
describe('[foundry] documentSymbol bug - Slang rejects transient as a name from 0.8.27, which solc still accepts', () => {
  ...
  before(async () => {
    ...
    transientNamePath = getProjectPath('foundry/src/document-symbols/bugs/transient-identifier/TransientName.sol')
