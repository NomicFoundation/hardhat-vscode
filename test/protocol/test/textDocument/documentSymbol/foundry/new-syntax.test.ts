...
describe('[foundry] documentSymbol - new-syntax', () => {
  ...
  before(async () => {
    ...
    layoutAtPath = getProjectPath('foundry/src/document-symbols/new-syntax/NsLayoutAt.sol')
    layoutErc7201Path = getProjectPath('foundry/src/document-symbols/new-syntax/NsLayoutErc7201.sol')
    operatorsPath = getProjectPath('foundry/src/document-symbols/new-syntax/NsOperators.sol')
    transientPath = getProjectPath('foundry/src/document-symbols/new-syntax/NsTransient.sol')
    namedMappingPath = getProjectPath('foundry/src/document-symbols/new-syntax/NsNamedMapping.sol')
    requireErrorPath = getProjectPath('foundry/src/document-symbols/new-syntax/NsRequireError.sol')
    qualifiedEmitPath = getProjectPath('foundry/src/document-symbols/new-syntax/NsQualifiedEmit.sol')
