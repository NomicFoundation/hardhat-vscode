...
describe('[foundry] definition - variables', () => {
  ...
  before(async () => {
    ...
    modifiersPath = getProjectPath('foundry/src/definition/variables/Modifiers.sol')
    basePath = getProjectPath('foundry/src/definition/variables/ModifierBase.sol')
    scopingPath = getProjectPath('foundry/src/definition/variables/Scoping.sol')
    stateKindsPath = getProjectPath('foundry/src/definition/variables/StateKinds.sol')
