...
describe('[foundry] definition bug - private member shadows inherited internal one', () => {
  ...
  before(async () => {
    ...
    shadowPath = getProjectPath('foundry/src/definition/bugs/private-shadows-internal/Shadow.sol')
