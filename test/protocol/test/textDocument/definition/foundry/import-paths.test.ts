...
describe('[foundry] definition - import-paths', () => {
  ...
  before(async () => {
    ...
    targetPath = getProjectPath('foundry/src/definition/import-paths/Target.sol')
    nestedPath = getProjectPath('foundry/src/definition/import-paths/nested/Nested.sol')
