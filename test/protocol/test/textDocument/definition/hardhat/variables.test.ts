...
describe('[hardhat] definition - variables', () => {
  ...
  before(async () => {
    ...
    modifiersPath = getProjectPath('hardhat/contracts/definition/variables/Modifiers.sol')
    basePath = getProjectPath('hardhat/contracts/definition/variables/ModifierBase.sol')
    scopingPath = getProjectPath('hardhat/contracts/definition/variables/Scoping.sol')
    stateKindsPath = getProjectPath('hardhat/contracts/definition/variables/StateKinds.sol')
