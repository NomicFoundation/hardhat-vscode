...
describe('[hardhat] definition - import-paths', () => {
  let targetPath: string
  let nestedPath: string

  before(async () => {
    client = await getInitializedClient()
    targetPath = getProjectPath('hardhat/contracts/definition/import-paths/Target.sol')
    nestedPath = getProjectPath('hardhat/contracts/definition/import-paths/nested/Nested.sol')
