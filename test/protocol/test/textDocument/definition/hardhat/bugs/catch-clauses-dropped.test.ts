...
describe('[hardhat] definition bug - catch clauses after the first are dropped', () => {
  let tryCatchPath: string

  before(async () => {
    client = await getInitializedClient()
    tryCatchPath = getProjectPath('hardhat/contracts/definition/errors-events/TryCatch.sol')
