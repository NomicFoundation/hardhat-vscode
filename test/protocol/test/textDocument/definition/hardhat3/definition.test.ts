...
describe('[hardhat3] definition', () => {
  ...
  before(async () => {
    ...
    testDocPath = getProjectPath('hardhat3/contracts/definition/Test.sol')
    importDocPath = getProjectPath('hardhat3/contracts/definition/ImportTest.sol')
    circular1DocPath = getProjectPath('hardhat3/contracts/definition/Circular1.sol')
    circular2DocPath = getProjectPath('hardhat3/contracts/definition/Circular2.sol')
