...
describe('[hardhat3] definition bug - private member shadows inherited internal one', () => {
  let shadowPath: string

  before(async () => {
    client = await getInitializedClient()
    shadowPath = getProjectPath('hardhat3/contracts/definition/bugs/private-shadows-internal/Shadow.sol')
