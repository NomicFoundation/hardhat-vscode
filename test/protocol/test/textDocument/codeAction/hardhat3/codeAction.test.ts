...
describe('[hardhat3][codeAction]', () => {
  ...
  test('add license identifier', async () => {
    const documentPath = getProjectPath('hardhat3/contracts/codeAction/NoLicense.sol')
    ...
    const expected = [
      {
        ...
        edit: {
          changes: {
            [toUri(getProjectPath('hardhat3/contracts/codeAction/NoLicense.sol'))]: [
              {
                range: {
                  start: {
                    character: 0,
  ...
  test('add multi override specifier', async () => {
    const documentPath = getProjectPath('hardhat3/contracts/codeAction/AddMultioverrideSpecifier.sol')
    const documentUri = toUri(documentPath)
    ...
    let expected = [
      {
        ...
        edit: {
          changes: {
            [toUri(getProjectPath('hardhat3/contracts/codeAction/AddMultioverrideSpecifier.sol'))]: [
              {
  ...
  test('add override specifier', async () => {
    const documentPath = getProjectPath('hardhat3/contracts/codeAction/AddOverrideSpecifier.sol')
    const documentUri = toUri(documentPath)
    ...
    const expected = [
      {
        ...
        edit: {
          changes: {
            [toUri(getProjectPath('hardhat3/contracts/codeAction/AddOverrideSpecifier.sol'))]: [
              {
                newText: '    override\n',
                range: {
                  start: {
  ...
  test('add pragma version', async () => {
    const documentPath = getProjectPath('hardhat3/contracts/codeAction/NoPragma.sol')
    const documentUri = toUri(documentPath)
    ...
    const expected = [
      {
        ...
        edit: {
          changes: {
            [toUri(getProjectPath('hardhat3/contracts/codeAction/NoPragma.sol'))]: [
              {
                range: {
                  start: {
                    character: 0,
                ...
                newText: 'pragma solidity ^0.8.28;\n',
              },
            ],
          },
        },
  ...
  test('add virtual specifier', async () => {
    const documentPath = getProjectPath('hardhat3/contracts/codeAction/AddVirtualSpecifier.sol')
    const documentUri = toUri(documentPath)
    ...
    const expected = [
      {
        ...
        edit: {
          changes: {
            [toUri(getProjectPath('hardhat3/contracts/codeAction/AddVirtualSpecifier.sol'))]: [
              {
                newText: ' virtual',
                range: {
                  start: {
  ...
  test('constrain mutability - view', async () => {
    const documentPath = getProjectPath('hardhat3/contracts/codeAction/ConstrainMutabilityView.sol')
    const documentUri = toUri(documentPath)
    ...
    const expected = [
      {
        ...
        edit: {
          changes: {
            [toUri(getProjectPath('hardhat3/contracts/codeAction/ConstrainMutabilityView.sol'))]: [
              {
                range: {
                  start: {
                    line: 6,
  ...
  test('constrain mutability - pure', async () => {
    const documentPath = getProjectPath('hardhat3/contracts/codeAction/ConstrainMutabilityPure.sol')
    const documentUri = toUri(documentPath)
    ...
    const expected = [
      {
        ...
        edit: {
          changes: {
            [toUri(getProjectPath('hardhat3/contracts/codeAction/ConstrainMutabilityPure.sol'))]: [
              {
                range: {
                  start: {
                    line: 4,
  ...
  test('constrain mutability - modify to pure', async () => {
    const documentPath = getProjectPath('hardhat3/contracts/codeAction/ConstrainMutabilityModifyToPure.sol')
    const documentUri = toUri(documentPath)
    ...
    const expected = [
      {
        ...
        edit: {
          changes: {
            [toUri(getProjectPath('hardhat3/contracts/codeAction/ConstrainMutabilityModifyToPure.sol'))]: [
              {
                range: {
                  start: {
                    line: 4,
  ...
  test('mark contract as abstract or implement interface', async () => {
    const documentPath = getProjectPath('hardhat3/contracts/codeAction/MarkAbstract.sol')
    const documentUri = toUri(documentPath)
    ...
    const expected = [
      {
        ...
        edit: {
          changes: {
            [toUri(getProjectPath('hardhat3/contracts/codeAction/MarkAbstract.sol'))]: [
              {
                range: {
                  start: {
                    line: 7,
  ...
  test('specify data location', async () => {
    const documentPath = getProjectPath('hardhat3/contracts/codeAction/SpecifyDataLocation.sol')
    const documentUri = toUri(documentPath)
    ...
    let expected = [
      {
        ...
        edit: {
          changes: {
            [toUri(getProjectPath('hardhat3/contracts/codeAction/SpecifyDataLocation.sol'))]: [
              {
                range: {
                  start: {
                    line: 5,
  ...
  test('specify visibility', async () => {
    const documentPath = getProjectPath('hardhat3/contracts/codeAction/SpecifyVisibility.sol')
    const documentUri = toUri(documentPath)
    ...
    const expected = [
      {
        ...
        edit: {
          changes: {
            [toUri(getProjectPath('hardhat3/contracts/codeAction/SpecifyVisibility.sol'))]: [
              {
                range: {
                  start: {
                    line: 4,
  ...
  test('invalid checksum addresses', async () => {
    const documentPath = getProjectPath('hardhat3/contracts/codeAction/InvalidChecksum.sol')
    const documentUri = toUri(documentPath)
  ...
  test('auto import console.sol', async () => {
    const documentPath = getProjectPath('hardhat3/contracts/codeAction/ImportConsole.sol')
    const documentUri = toUri(documentPath)
