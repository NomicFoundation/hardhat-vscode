...
describe('[hardhat] rename - udvt-using (not implemented)', () => {
  ...
  before(async () => {
    ...
    amountPath = getProjectPath('hardhat/contracts/references/udvt-using/UuAmount.sol')
    useAmountPath = getProjectPath('hardhat/contracts/references/udvt-using/UuUseAmount.sol')
    rnMoneyPath = getProjectPath('hardhat/contracts/rename/udvt-using/RnMoney.sol')
