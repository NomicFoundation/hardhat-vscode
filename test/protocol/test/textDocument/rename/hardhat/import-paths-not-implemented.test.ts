...
describe('[hardhat] rename - import-paths (not implemented)', () => {
  ...
  before(async () => {
    ...
    contextPath = getProjectPath('hardhat/contracts/../node_modules/@openzeppelin/contracts/utils/Context.sol')
    ozPath = getProjectPath('hardhat/contracts/../node_modules/@openzeppelin/contracts/access/Ownable.sol')
    consoleSolPath = getProjectPath('hardhat/contracts/../node_modules/hardhat/console.sol')
    sharedPath = getProjectPath('hardhat/contracts/rename/import-paths/shared/RnIpShared.sol')
    rnNestedPath = getProjectPath('hardhat/contracts/rename/import-paths/nested/RnIpNestedUser.sol')
    rnRemapPath = getProjectPath('hardhat/contracts/rename/import-paths/RnIpRemapUser.sol')
    ipOwnablePath = getProjectPath('hardhat/contracts/references/import-paths/IpOwnable.sol')
    rnIpOwnablePath = getProjectPath('hardhat/contracts/rename/import-paths/RnIpOwnable.sol')
    fileRenamePath = getProjectPath('hardhat/contracts/misc/FileRename.sol')
    importTestPath = getProjectPath('hardhat/contracts/definition/ImportTest.sol')
    ipConsolePath = getProjectPath('hardhat/contracts/references/import-paths/IpConsole.sol')
    consoleCallerPath = getProjectPath('hardhat/contracts/definition/bugs/overload-resolution/ConsoleCaller.sol')
