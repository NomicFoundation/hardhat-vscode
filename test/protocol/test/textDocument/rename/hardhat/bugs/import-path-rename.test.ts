...
describe('[hardhat] rename bug - an import path string is renamed', () => {
  let libPath: string
  ...
  before(async () => {
    ...
    ipBasePath = getProjectPath('hardhat/contracts/references/import-paths/IpBase.sol')
    ipNestedPath = getProjectPath('hardhat/contracts/references/import-paths/nested/IpNested.sol')
    ipDeepPath = getProjectPath('hardhat/contracts/references/import-paths/deep/inner/IpDeep.sol')
