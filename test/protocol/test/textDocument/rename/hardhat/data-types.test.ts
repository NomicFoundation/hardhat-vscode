...
describe('[hardhat] rename - data-types', () => {
  ...
  before(async () => {
    ...
    shapesPath = getProjectPath('hardhat/contracts/rename/data-types/DtShapes.sol')
    builderPath = getProjectPath('hardhat/contracts/rename/data-types/DtBuilder.sol')
