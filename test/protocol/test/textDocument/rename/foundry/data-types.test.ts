...
describe('[foundry] rename - data-types', () => {
  ...
  before(async () => {
    ...
    shapesPath = getProjectPath('foundry/src/rename/data-types/DtShapes.sol')
    builderPath = getProjectPath('foundry/src/rename/data-types/DtBuilder.sol')
    membersPath = getProjectPath('foundry/src/references/data-types/DtMembers.sol')
