...
describe('[foundry] rename bug - override chains linked by name alone and only to direct bases', () => {
  ...
  before(async () => {
    ...
    functionsPath = getProjectPath('foundry/src/rename/functions/FunctionRename.sol')
