...
describe('[hardhat3] rename bug - names in an import brace list are never bound', () => {
  ...
  before(async () => {
    ...
    refDefsPath = getProjectPath('hardhat3/contracts/references/file-level/FlRefDefs.sol')
    refUserPath = getProjectPath('hardhat3/contracts/references/file-level/FlRefUser.sol')
    ...
    dtShapesPath = getProjectPath('hardhat3/contracts/rename/data-types/DtShapes.sol')
    dtBuilderPath = getProjectPath('hardhat3/contracts/rename/data-types/DtBuilder.sol')
