...
describe('[hardhat3] rename bug - an alias and its original are renamed together', () => {
  ...
  before(async () => {
    ...
    ifUserCPath = getProjectPath('hardhat3/contracts/references/import-forms/IfUserC.sol')
    flRefDefsPath = getProjectPath('hardhat3/contracts/references/file-level/FlRefDefs.sol')
    flRefUserPath = getProjectPath('hardhat3/contracts/references/file-level/FlRefUser.sol')
    uuAmountPath = getProjectPath('hardhat3/contracts/references/udvt-using/UuAmount.sol')
    uuUseAmountPath = getProjectPath('hardhat3/contracts/references/udvt-using/UuUseAmount.sol')
