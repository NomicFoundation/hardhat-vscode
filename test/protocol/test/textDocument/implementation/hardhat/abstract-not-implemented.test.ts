...
describe('[hardhat] implementation - abstract (not implemented)', () => {
  let shapesPath: string
  let concretePath: string

  before(async () => {
    client = await getInitializedClient()
    shapesPath = getProjectPath('hardhat/contracts/implementation/abstract/Shapes.sol')
    concretePath = getProjectPath('hardhat/contracts/implementation/abstract/Concrete.sol')
