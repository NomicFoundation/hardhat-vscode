...
describe('[hardhat3] implementation - interfaces (not implemented)', () => {
  ...
  before(async () => {
    ...
    shapesPath = getProjectPath('hardhat3/contracts/implementation/interfaces/Shapes.sol')
    implsPath = getProjectPath('hardhat3/contracts/implementation/interfaces/Impls.sol')
    usesPath = getProjectPath('hardhat3/contracts/implementation/interfaces/Uses.sol')
