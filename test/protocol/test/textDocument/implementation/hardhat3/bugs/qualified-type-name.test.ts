...
describe('[hardhat3] implementation bug - qualified type name looked up as one dotted name', () => {
  ...
  before(async () => {
    ...
    typesPath = getProjectPath('hardhat3/contracts/implementation/type-kinds/TkTypes.sol')
    shapesPath = getProjectPath('hardhat3/contracts/implementation/type-kinds/TkShapes.sol')
    otherPath = getProjectPath('hardhat3/contracts/implementation/type-kinds/TkOther.sol')
