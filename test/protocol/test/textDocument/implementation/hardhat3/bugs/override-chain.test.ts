...
describe('[hardhat3] implementation bug - override chains linked by name, to direct bases only, in both directions', () => {
  ...
  before(async () => {
    ...
    abShapesPath = getProjectPath('hardhat3/contracts/implementation/abstract/Shapes.sol')
    abConcretePath = getProjectPath('hardhat3/contracts/implementation/abstract/Concrete.sol')
    ifcShapesPath = getProjectPath('hardhat3/contracts/implementation/interfaces/Shapes.sol')
    ifcImplsPath = getProjectPath('hardhat3/contracts/implementation/interfaces/Impls.sol')
    ifcUsesPath = getProjectPath('hardhat3/contracts/implementation/interfaces/Uses.sol')
