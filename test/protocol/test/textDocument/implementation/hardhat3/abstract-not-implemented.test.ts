...
describe('[hardhat3] implementation - abstract (not implemented)', () => {
  let shapesPath: string
  let concretePath: string

  before(async () => {
    client = await getInitializedClient()
    shapesPath = getProjectPath('hardhat3/contracts/implementation/abstract/Shapes.sol')
    concretePath = getProjectPath('hardhat3/contracts/implementation/abstract/Concrete.sol')
