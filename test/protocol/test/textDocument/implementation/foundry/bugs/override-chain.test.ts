...
describe('[foundry] implementation bug - override chains linked by name, to direct bases only, in both directions', () => {
  ...
  before(async () => {
    ...
    abShapesPath = getProjectPath('foundry/src/implementation/abstract/Shapes.sol')
    abConcretePath = getProjectPath('foundry/src/implementation/abstract/Concrete.sol')
    ifcShapesPath = getProjectPath('foundry/src/implementation/interfaces/Shapes.sol')
    ifcImplsPath = getProjectPath('foundry/src/implementation/interfaces/Impls.sol')
    ifcUsesPath = getProjectPath('foundry/src/implementation/interfaces/Uses.sol')
