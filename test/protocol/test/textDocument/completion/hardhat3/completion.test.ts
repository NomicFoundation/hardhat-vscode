...
describe('[hardhat3][completion]', () => {
  ...
  describe('imports', function () {
    ...
    test.skip('hardhat node_modules contract import completion on partial specification', async () => {
      const documentPath = getProjectPath('hardhat3/contracts/completion/Imports.sol')
      const documentUri = toUri(documentPath)
      await client.openDocument(documentPath)
    ...
    test.skip('hardhat node_modules contract import completion on module specified', async () => {
      const documentPath = getProjectPath('hardhat3/contracts/completion/Imports.sol')
      const documentUri = toUri(documentPath)
      await client.openDocument(documentPath)
    ...
    test.skip('hardhat node_modules contract import completion on module and partial contract', async () => {
      const documentPath = getProjectPath('hardhat3/contracts/completion/Imports.sol')
      const documentUri = toUri(documentPath)
      await client.openDocument(documentPath)
    ...
    test.skip('auto appending of semicolon', async () => {
      const documentPath = getProjectPath('hardhat3/contracts/completion/Imports.sol')
      const documentUri = toUri(documentPath)
      await client.openDocument(documentPath)
  ...
  describe('globals', function () {
    describe('abi', function () {
      test('gives completion for all of abi methods', async () => {
        const documentPath = getProjectPath('hardhat3/contracts/completion/Globals.sol')
        const documentUri = toUri(documentPath)
        await client.openDocument(documentPath)
    ...
    describe('multi line', function () {
      describe('function natspec', function () {
        test('natspec completion on function with 2 return values, 1 named 1 unnamed', async () => {
          const documentPath = getProjectPath('hardhat3/contracts/completion/Natspec.sol')
          const documentUri = toUri(documentPath)
          await client.openDocument(documentPath)
    ...
    describe('single line', function () {
      describe('function natspec', function () {
        test('natspec completion on function with 2 return values', async () => {
          const documentPath = getProjectPath('hardhat3/contracts/completion/NatspecSingle.sol')
          const documentUri = toUri(documentPath)
          await client.openDocument(documentPath)
