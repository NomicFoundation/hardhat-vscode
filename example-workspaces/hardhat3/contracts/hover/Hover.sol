...
contract AuctionBase {
    function stateInt() external virtual returns (uint256) {
        return 1;
    }

    // string internal inheritedString = "Hello";
    // bool private inheritedBool = true;
    // uint public constant override inheritedInt = 123;
    // address payable public inheritedAddr;
}
...
contract Auction is AuctionBase {
    ...
    uint public constant override stateInt = 123;
